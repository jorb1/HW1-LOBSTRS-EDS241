...
d.  Discuss the following causal inference assumptions in the context of the MPA treatment effect estimator. Evaluate if each of the assumption are reasonable:
    ...
    ** This assumption assumes that there are no other causal effects in play. This is probably not possible in our study, as there are many variables that might be affecting the lobsters, not just MPA designation.**
------------------------------------------------------------------------
